...
final class FormTest extends TestCase
{
    ...
    {
        $form = Form::groups(
            \SugarCraft\Forms\Group::new(Input::new('a')),
            \SugarCraft\Forms\Group::new(Input::new('b')),
        );
    ...
    public function testGroupHideFuncSkipsGroup(): void
    {
        $form = Form::groups(
            ...
            \SugarCraft\Forms\Group::new(Input::new('c')),
        );
    ...
    {
        $form = Form::new(Input::new('a'))
            ->withTheme(\SugarCraft\Forms\Theme::dracula());
        $this->assertSame(\SugarCraft\Forms\Theme::dracula()::class, $form->theme::class);
    }
    ...
    public function testGroupViewIncludesTitleAndDescription(): void
    {
        ...
        )->withTheme(\SugarCraft\Forms\Theme::plain());
        $out = $form->view();
    ...
    {
        $custom = \SugarCraft\Forms\Theme::ansi();
        $form = Form::groups(
            \SugarCraft\Forms\Group::new(Input::new('a'))->withTheme($custom),
        );
        // Group override wins.
        $this->assertSame($custom, $form->activeTheme());

        // Group with no override falls back to form theme.
        $form2 = Form::groups(\SugarCraft\Forms\Group::new(Input::new('a')));
